...
//           if (!acc[label]) {
//             acc[label] = { baseColor: color, subcategories: [] };
//           }
...
//           fill={fill}
//         />
//         {/* <text x={cx + outerRadius + 30} y={cy - 20} textAnchor="start" fill={fill} style={{ fontWeight: "bold" }}>
//           {payload.isDomain ? payload.mainCategory : payload.name}
//         </text>
//         <text x={cx + outerRadius + 30} y={cy} textAnchor="start" fill={fill}>
//           {payload.isDomain ? payload.percentage : `₹${new Intl.NumberFormat("en-IN").format(value)}`}
//         </text> */}
//       </g>
//     );
//   };
...
//               ))}
//             </Pie>
//             {/* Keep this tooltip and remove any redundant tooltip logic */}
//             <Tooltip
//               content={
//                 tooltipContent ? (
